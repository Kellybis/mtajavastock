...
import kelly.org.service.DatastoreService;
...
/**
 * Stock trend api entry. Parameters: symbol which we like to get trend of.
 * 
 * @author hanang
 */
...
public class StockServlet extends AbstractAlgoServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		List<StockStatus> stockHistory = DatastoreService.getInstance()
